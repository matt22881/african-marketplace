...
exports.seed = function(knex) {
    return knex('items').insert([
      {name: 'eggs', description: "seed testing data", price: 3, location: "Sauti", category: "Animal Products", user_id: 2, URL: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQAdHhqJOD5CGPHT8KJtpbXCIxTfoAo5RLGxVCxnxGkYKvu1NQzhg"},
